...
import { CfnAuthorizer, AuthorizationType, RequestValidator, LambdaIntegration, ProxyResource, Resource, RestApi, Model, JsonSchemaType } from 'aws-cdk-lib/aws-apigateway'
...
export class ApiStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: apiStackProps) {
    ...
    this.restApi = new RestApi(this, 'travelMapRestApi', {})
    ...
    new ProxyResource(this, 'authApiProxyResource', {
