...
def get_secret_hash(
    cognito: CognitoIdentityProviderClient, env: Dict, username: str, client_id: str
) -> str:
    client_secret = get_client_secret(cognito, env, client_id)
    return _calculate_secret_hash(username, client_id, client_secret)


def get_client_secret(
    cognito: CognitoIdentityProviderClient, env: Dict, client_id: str
) -> str:
